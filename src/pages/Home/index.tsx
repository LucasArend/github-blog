...
export function Home() {
  ...
  const fetchPosts = useCallback(async (query: string | null) => {
    // https://api.github.com/search/issues?q=is:issue%20is:open%20repo:LucasArend/github-blog
    const response = await api.get(
      `search/issues?q=${query}is:issue%20is:open%20repo:LucasArend/github-blog`,
    )
